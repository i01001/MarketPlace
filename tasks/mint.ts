...
.setAction(async (taskArgs,hre) => {
  ...
  await marketPlace.connect(sender).setNFT1155ContractAddress(mNF1155.address);

  let output = await marketPlace.connect(sender).createItem(taskArgs.bool, taskArgs.tokenuri,taskArgs.amountfornft1155);
